...
class TestModelGpsReceiver(unittest.TestCase):
    ...
    def test_get_output_returns_info_when_fix_is_valid(self):
        expected_valid_data = [
            ...
            '$GLGSA,A,3,65,67,68,71,73,74,77,84,85,86,89,93,1.0,1.0,1.0*26',
            '$GLGSV,3,1,12,65,82,303,37,67,43,184,34,68,19,282,33,71,71,101,37*6F',
            '$GLGSV,3,2,12,73,71,327,39,74,21,291,39,77,56,169,31,84,65,296,36*61',
            '$GLGSV,3,3,12,85,55,0,34,86,7,312,32,89,76,85,39,93,10,39,35*54',
        ...
        expected_invalid_data = [
            ...
            '$GLGSA,A,1,65,67,68,71,73,74,77,84,85,86,89,93,1.0,1.0,1.0*24',
            '$GLGSV,3,1,12,65,82,303,37,67,43,184,34,68,19,282,33,71,71,101,37*6F',
            '$GLGSV,3,2,12,73,71,327,39,74,21,291,39,77,56,169,31,84,65,296,36*61',
            '$GLGSV,3,3,12,85,55,0,34,86,7,312,32,89,76,85,39,93,10,39,35*54',
